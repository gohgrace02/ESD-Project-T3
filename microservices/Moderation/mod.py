...
# sends get req to webpurify api endpoint
...
def moderate():
    ...
    params = {
        ...
        "text": text,
        "format": "json",
        "api_key": "07e7c189b92ff357331ffe3183a48578"
    }
    response = requests.get("http://api1-ap.webpurify.com/services/rest/", params=params).json()
    # returns 0 if no vulgarities found, 1 if found
    return response['rsp']['found']
    
       
       
    

    # return response['rsp']['@attributes']['stat']
